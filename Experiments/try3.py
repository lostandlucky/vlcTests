...
class MediaSlideshow():
    def __init__(self, root, media_folder, delay=3000, video_duration=5000):
        super().__init__()
    ...
    def show_image(self, image_path):
        ...
        self.root.after(self.delay, self.cycle_media)
    ...
    def show_video(self, video_path):
        ...
        self.root.after(self.video_duration, self.stop_video)
...
if __name__ == "__main__":
    ...
    app = MediaSlideshow(root, folder_path, delay=3000, video_duration=5000)  # Delay is in milliseconds for images, 5 seconds for videos
